...
if("TRUE" STREQUAL "TRUE")
  set(hector_trajectory_server_SOURCE_PREFIX /home/jose/cecs_461_ws/src/hector_slam/hector_trajectory_server)
  set(hector_trajectory_server_DEVEL_PREFIX /home/jose/cecs_461_ws/devel/.private/hector_trajectory_server)
  ...
  set(hector_trajectory_server_INSTALL_PREFIX /home/jose/cecs_461_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_trajectory_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jose/cecs_461_ws/src/hector_slam/hector_trajectory_server/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jose/cecs_461_ws/devel/.private/hector_trajectory_server/lib;/home/jose/cecs_461_ws/devel/lib;/opt/ros/kinetic/lib)
