...
if("TRUE" STREQUAL "TRUE")
  set(openni_launch_SOURCE_PREFIX /home/jose/cecs_461_ws/src/openni_camera/openni_launch)
  set(openni_launch_DEVEL_PREFIX /home/jose/cecs_461_ws/devel/.private/openni_launch)
  ...
  set(openni_launch_INSTALL_PREFIX /home/jose/cecs_461_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openni_launch' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jose/cecs_461_ws/src/openni_camera/openni_launch/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jose/cecs_461_ws/devel/.private/openni_launch/lib;/home/jose/cecs_461_ws/devel/lib;/opt/ros/kinetic/lib)
